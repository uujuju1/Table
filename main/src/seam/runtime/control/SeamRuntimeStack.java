...
public final class SeamRuntimeStack {
	...
	public void enter(WorldRuntime runtime) {
		...
		ContextSnapshot snapshot = new ContextSnapshot(runtime);
	...
	private static final class ContextSnapshot {
		...
		ContextSnapshot(WorldRuntime runtime) {
			world = Vars.world;
			state = Vars.state;
			collisions = Vars.collisions;
			...
			captureDelayedRuns = runtime != null && !runtime.main();
			delayedRunStart = captureDelayedRuns ? DelayedRunBridge.size() : -1;
		}
